...
netVisual_chord_gene <- function(object, slot.name = "net", color.use = NULL,
                                 ...
                                 thresh = 0.05, annotationTrackHeight=1, preAllocateTracks=1, 
                                 ...){
  if (!is.null(pairLR.use)) {
  ...
  chordDiagram(df.plot,
               ...
               annotationTrack = "grid",
               annotationTrackHeight = circlize::mm_h(annotationTrackHeight),
               preAllocateTracks = list(track.height = circlize::mm_h(preAllocateTracks)),
               small.gap = small.gap,
               big.gap = big.gap,
               link.visible = link.visible,
               scale = scale,
