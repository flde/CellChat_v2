...
netVisual_chord_gene <- function(object, slot.name = "net", color.use = NULL,
                                 ...
                                 thresh = 0.05, track_height=1, allocate_track=1, 
                                 ...){
  if (!is.null(pairLR.use)) {
  ...
  chordDiagram(df.plot,
               ...
               annotationTrack = "grid",
               annotationTrackHeight = circlize::mm_h(track_height),
               preAllocateTracks = list(track.height = circlize::mm_h(allocate_track)),
               small.gap = small.gap,
               big.gap = big.gap,
               link.visible = link.visible,
               scale = scale,
